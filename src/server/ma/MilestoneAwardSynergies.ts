...
const synergiesData: Array<[MilestoneName | AwardName, MilestoneName | AwardName, number]> = [
  ...
  ['Tropicalist', 'C. Forester', 1],
  ['Gambler', 'C. Forester', 0.5],
  ['Coastguard', 'C. Forester', 1],
  ['A. Engineer', 'C. Forester', 4],
  ['Tourist', 'C. Forester', 1],
  ...
  ['Entrepreneur', 'Coastguard', 4],
  ['Tourist', 'Coastguard', 1],

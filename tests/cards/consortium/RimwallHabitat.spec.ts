...
import {RimwallHabitat} from '../../../src/server/cards/consortium/RimwallHabitat';
...
describe('RimwallHabitat', () => {
  it('requires highland ownership, places city on highland, +2 M€ prod', () => {
    const card = new RimwallHabitat();
